...
const Banner = () => {
  return (
    <div className="hero w-full md:max-w-[85%] mx-auto">
      <div className="hero-content text-center max-w-none flex-col">
        ...
        <div className="grid-tiles grid w-full grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">

          <div className="py-8 px-10 rounded-lg flex flex-col bg-white shadow-sm">
            <h2 className="text-[#244D3F] font-semibold text-4xl">10</h2>
